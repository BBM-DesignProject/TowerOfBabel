...
namespace TowerOfBabel.Input
{
    ...
    ""maps"": [
        {
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""4be7f056-f154-4894-b35b-80f88e211475"",
                    ""path"": ""<Mouse>/position"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
        ...
        {
            ""name"": ""DrawingSystem"",
            ""id"": ""efc05a21-4a11-49c8-b5af-852c9266d4f2"",
            ""actions"": [
                {
                    ""name"": ""Activate"",
                    ""type"": ""Button"",
                    ""id"": ""8bd75c94-c889-4b9d-af49-fa6cfa57045a"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""Consume"",
                    ""type"": ""Button"",
                    ""id"": ""8518a96e-d7da-49ef-84fb-22d8eacb5b7b"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""Cancel"",
                    ""type"": ""Button"",
                    ""id"": ""9fdeff1a-2d6b-4f8a-a7ff-b85c8bdfb6fa"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
    ...
    ""controlSchemes"": [
        ...
        },
        {
            ...
            // DrawingSystem
            m_DrawingSystem = asset.FindActionMap("DrawingSystem", throwIfNotFound: true);
        ...
        ~@PlayerInputs()
        {
            ...
            UnityEngine.Debug.Assert(!m_DrawingSystem.enabled, "This will cause a leak and performance issues, PlayerInputs.DrawingSystem.Disable() has not been called.");
        }
        ...
        // DrawingSystem
        private readonly InputActionMap m_DrawingSystem;
        private List<IDrawingSystemActions> m_DrawingSystemActionsCallbackInterfaces = new List<IDrawingSystemActions>();
        ...
        {
            private @PlayerInputs m_Wrapper;
            public DrawingSystemActions(@PlayerInputs wrapper) { m_Wrapper = wrapper; }
            ...
            public void Disable() { Get().Disable(); }
            public bool enabled => Get().enabled;
            public static implicit operator InputActionMap(DrawingSystemActions set) { return set.Get(); }
            public void AddCallbacks(IDrawingSystemActions instance)
            {
                if (instance == null || m_Wrapper.m_DrawingSystemActionsCallbackInterfaces.Contains(instance)) return;
                m_Wrapper.m_DrawingSystemActionsCallbackInterfaces.Add(instance);
            ...
            {
                if (m_Wrapper.m_DrawingSystemActionsCallbackInterfaces.Remove(instance))
                    UnregisterCallbacks(instance);
            }

            public void SetCallbacks(IDrawingSystemActions instance)
            {
                foreach (var item in m_Wrapper.m_DrawingSystemActionsCallbackInterfaces)
                    UnregisterCallbacks(item);
                m_Wrapper.m_DrawingSystemActionsCallbackInterfaces.Clear();
                AddCallbacks(instance);
            }
        }
        public DrawingSystemActions @DrawingSystem => new DrawingSystemActions(this);
        ...
        public interface IDrawingSystemActions
        {
